...
#+BEGIN_SRC emacs-lisp
(setq org-agenda-files (append (directory-files-recursively "~/mind/org" "\.org$")
			       (directory-files-recursively "~/mind/journal" "\.org$")
			       (directory-files-recursively "~/mind/web/content/" "\.org$")
			       (directory-files-recursively "~/mind/pin/" "\.org$")
			       )
      )
