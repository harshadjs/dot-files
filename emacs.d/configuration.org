...
(setq org-default-notes-file "~/mind/inbox.org")
...
#+BEGIN_SRC emacs-lisp
(setq org-agenda-files (directory-files-recursively "~/mind/projects" "\.org$"))
(add-to-list 'org-agenda-files "~/.emacs.d/configuration.org")
(add-to-list 'org-agenda-files "~/mind/inbox.org")
(add-to-list 'org-agenda-files "~/mind/habits.org")
(add-to-list 'org-agenda-files "~/mind/reminders.org")
#+END_SRC
...
**** View nodes only configuration
     ...
     appropriate project under mind/projects.
#+BEGIN_SRC comment
...
(setq org-capture-templates
      (quote (("t" "todo" entry (file "~/mind/inbox.org")
               "* TODO %?\n%U\n%a\n")
	      ("r" "reminder" entry (file "~/mind/reminders.org")
...
(setq org-roam-capture-templates '(("d" "default" plain "%?"
     :if-new (file+head "~/mind/nodes/${slug}.org"
                        "#+title: ${title}\n")
     :unnarrowed t)))
...
(setq org-roam-dailies-directory (file-truename "~/mind/journal"))
(setq org-roam-graph-executable "/usr/local/bin/dot")
...
(setq org-roam-capture-templates
	 ...
	 :unnarrowed t)
	("p" "project" plain "%?"
	 :if-new (file+head "~/mind/projects/${slug}.org"
                        "#+title: ${title}\n* ${title} :project:")
	 :unnarrowed t))
      )
