...
** TODO Use electric-pair mode instead of auto-pair mode
...
(setq org-agenda-custom-commands
      (quote (
		...
		(tags-todo "+work/WORKING|NEXT|TODO|BLOCKED"
                      ((org-agenda-overriding-header (hs/org-style-sub-header "Work"))
		       (org-agenda-compact-blocks t)
                       (org-tags-match-list-sublevels t)
		       (org-agenda-sorting-strategy '(todo-state-down priority-down))))
		(tags-todo "-work/WORKING|NEXT|TODO|BLOCKED"
                      ((org-agenda-overriding-header (hs/org-style-sub-header "Personal"))
		       (org-agenda-compact-blocks t)
                       (org-tags-match-list-sublevels t)
		       (org-agenda-sorting-strategy '(todo-state-down priority-down))))
		(tags "+project"
                      ((org-agenda-overriding-header (hs/org-style-sub-header "Projects in Motion"))
		       (org-agenda-compact-blocks t)
                       (org-tags-match-list-sublevels nil)))
		(stuck ""
