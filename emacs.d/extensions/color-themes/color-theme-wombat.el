...
;(defvar wombat-green "#95e454") ; original : #95e454
...
(defun color-theme-wombat (&optional frame)
  ...
  (interactive)
  ;; set font
  (set-frame-parameter frame 'font "Envy Code R 13")
  (color-theme-install
   `(color-theme-wombat
     ((background-color . ,wombat-bg)
      (background-mode . dark)
      (border-color . ,wombat-bg)
      (cursor-color . ,wombat-green)
      (foreground-color . ,"white")
      (mouse-color . "white"))

     ;; Font Lock
     (font-lock-builtin-face ((t (:foreground ,wombat-blue))))
     (font-lock-comment-delimiter-face ((t (:italic t :slant italic :foreground ,wombat-orange))))
     (font-lock-comment-face ((t (:italic t :slant italic :foreground ,wombat-orange))))
     (font-lock-comment-face ((t (:italic t :slant italic :foreground ,wombat-orange))))
     (font-lock-constant-face ((t (:foreground ,wombat-red))))
     (font-lock-doc-face ((t (:foreground ,wombat-gray+1))))
     (font-lock-function-name-face ((t (:foreground ,wombat-purple :bold t :italic t))))
     (font-lock-keyword-face ((t (:bold t :weight bold :foreground ,wombat-blue))))
     (font-lock-negation-char-face ((t (:foreground ,wombat-red))))
     (font-lock-preprocessor-face ((t (:bold t :weight bold :foreground ,wombat-purple-1))))
     (font-lock-regexp-grouping-backslash ((t (:bold t :weight bold))))
     (font-lock-regexp-grouping-construct ((t (:bold t ,wombat-green))))
     (font-lock-string-face ((t (:italic t :foreground ,wombat-red-1))))
     ...
     (org-archived ((t (:foregroupnd "#8f8f8f"))))
